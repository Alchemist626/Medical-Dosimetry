...
st.set_page_config(page_title="MU Calculator", layout="centered")
...
# --- Inputs with sensitivity tooltips ---
...
def sensitivity(var_name, inputs, inc, energy, geometry, SSD_input):
    percent_dd = lookup_percent_dd(energy, inputs["depth"])
    ...
    for d in [up, down]:
        percent_dd = lookup_percent_dd(energy, d["depth"])
